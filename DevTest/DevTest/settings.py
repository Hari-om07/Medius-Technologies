...
SECRET_KEY = 'django-insecure-kf_g5!y1(d(g2fo$2b&t*ob4v9%b=&m6d51wm$em$ia$qo7(6d'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['medius-technologies-0am6.onrender.com', 'localhost', '127.0.0.1']
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'DevTest/uploadfile/static'),  # Adjust this path to your static folder
]
